...
#ifndef PAND_RSRQ_HANDOVER_ALGORITHM_H
#define PAND_RSRQ_HANDOVER_ALGORITHM_H
 ...
 */
class PandHandoverAlgorithm : public LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  PandHandoverAlgorithm ();

  virtual ~PandHandoverAlgorithm ();
  ...
  friend class MemberLteHandoverManagementSapProvider<PandHandoverAlgorithm>;
...
private:
   ...
   */
  void EvaluateHandover (uint16_t rnti, uint8_t servingCellRsrq, uint16_t servingCellId);
...
}; // end of class PandHandoverAlgorithm
